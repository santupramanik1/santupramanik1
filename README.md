<!-- ═══════════════════════════════════════════════════════════════ -->
<!--           GITHUB PROFILE README — INTERACTIVE TEMPLATE        -->
<!--   Replace all YOUR_* placeholders with your actual details    -->
<!-- ═══════════════════════════════════════════════════════════════ -->


<!-- ──────────────────────────────────────────────────────────────
  SECTION 1 ▸ ANIMATED HEADER
  Customize the text lines at the end of the URL below.
  Use %20 for spaces, %2C for commas, + for line breaks between items.
─────────────────────────────────────────────────────────────────── -->

<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&duration=3000&pause=1000&color=2DA44E&center=true&vCenter=true&width=850&lines=Hi+there%2C+I'm+santu+Pramanik+%F0%9F%91%8B;Full+Stack+Developer+%7C+Open+Source+Lover;Building+cool+things+one+commit+at+a+time)](https://git.io/typing-svg)

</div>


<!-- ──────────────────────────────────────────────────────────────
  SECTION 2 ▸ PROFILE VIEWS + SOCIAL BADGES
  Replace YOUR_USERNAME, YOUR_LINKEDIN_ID, YOUR_TWITTER_HANDLE,
...
<!-- ──────────────────────────────────────────────────────────────
  SECTION 3 ▸ ABOUT ME
  Write a punchy 3–5 line bio. Keep it personal but professional.
─────────────────────────────────────────────────────────────────── -->
...
<!-- ──────────────────────────────────────────────────────────────
  ...
  Add / remove badges to match your actual skills.
  Browse all logos at: https://shields.io  &  https://simpleicons.org
─────────────────────────────────────────────────────────────────── -->
...
<div align="center">
  ...
  <a href="https://github.com/YOUR_USERNAME/REPO_NAME_2">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=YOUR_USERNAME&repo=REPO_NAME_2&theme=tokyonight&hide_border=true" />
  </a>
</div>
-->
...
<!-- ──────────────────────────────────────────────────────────────
  ...
  Replace YOUR_USERNAME. Themes: react-dark | github-compact |
  tokyo-night | merko | dracula
─────────────────────────────────────────────────────────────────── -->
